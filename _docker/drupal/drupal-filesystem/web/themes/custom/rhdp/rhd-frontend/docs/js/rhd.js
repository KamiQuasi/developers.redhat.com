...
System.register("@rhd/rhdp-search/rhdp-search-url", ["@rhelements/rhelement"], function (exports_8, context_8) {
    "use strict";
...
System.register("@rhd/rhdp-search/rhdp-search-filter-item", ["@rhelements/rhelement"], function (exports_9, context_9) {
    "use strict";
...
System.register("@rhd/rhdp-search/rhdp-search-query", ["@rhelements/rhelement"], function (exports_10, context_10) {
    "use strict";
...
System.register("@rhd/rhdp-search/rhdp-search-box", ["@rhelements/rhelement"], function (exports_11, context_11) {
    "use strict";
...
System.register("@rhd/rhdp-search/rhdp-search-result-count", ["@rhelements/rhelement"], function (exports_12, context_12) {
    "use strict";
...
System.register("@rhd/rhdp-search/rhdp-search-filter-group", ["@rhelements/rhelement"], function (exports_13, context_13) {
    "use strict";
...
System.register("@rhd/rhdp-search/rhdp-search-filters", ["@rhelements/rhelement", "@rhd/rhdp-search/rhdp-search-filter-group", "@rhd/rhdp-search/rhdp-search-filter-item"], function (exports_14, context_14) {
    "use strict";
        ...
        execute: function () {
            RHDPSearchFilters = (function (_super) {
                ...
                function RHDPSearchFilters() {
                    var _this = _super.call(this, 'rhdp-search-filters') || this;
                    _this.template = function (el) {
                        var tpl = document.createElement("template");
...
System.register("@rhd/rhdp-search/rhdp-search-filter-item-inline", ["@rhelements/rhelement"], function (exports_15, context_15) {
    "use strict";
    var __moduleName = context_15 && context_15.id;
    var rhelement_14, RHDPSearchFilterItemInline;
    return {
        setters: [
        ...
        execute: function () {
            RHDPSearchFilterItemInline = (function (_super) {
                __extends(RHDPSearchFilterItemInline, _super);
                function RHDPSearchFilterItemInline() {
                    var _this = _super.call(this, 'rhdp-search-filter-item-inline') || this;
                    _this.template = function (el) {
                        var tpl = document.createElement("template");
                        var checked = el.active ? 'checked' : '';
                ...
                Object.defineProperty(RHDPSearchFilterItemInline.prototype, "name", {
                    get: function () {
                        return this._name;
                    },
                    set: function (val) {
                ...
                Object.defineProperty(RHDPSearchFilterItemInline.prototype, "key", {
                    get: function () {
                        return this._key;
                    },
                    set: function (val) {
                ...
                Object.defineProperty(RHDPSearchFilterItemInline.prototype, "group", {
                    get: function () {
                        return this._group;
                    },
                    set: function (val) {
                ...
                Object.defineProperty(RHDPSearchFilterItemInline.prototype, "bubble", {
                    get: function () {
                        return this._bubble;
                    },
                    set: function (val) {
                ...
                Object.defineProperty(RHDPSearchFilterItemInline.prototype, "bounce", {
                    get: function () {
                        return this._bounce;
                    },
                    set: function (val) {
                ...
                Object.defineProperty(RHDPSearchFilterItemInline.prototype, "active", {
                    get: function () {
                        return this._active;
                    },
                    set: function (val) {
                ...
                Object.defineProperty(RHDPSearchFilterItemInline.prototype, "value", {
                    get: function () {
                        return this._value;
                    },
                    set: function (val) {
                ...
                RHDPSearchFilterItemInline.prototype.connectedCallback = function () {
                    _super.prototype.render.call(this, this.template(this));
                ...
                Object.defineProperty(RHDPSearchFilterItemInline, "observedAttributes", {
                    get: function () {
                        return ['name', 'active', 'value', 'key', 'group'];
                    },
                    enumerable: true,
                ...
                RHDPSearchFilterItemInline.prototype.attributeChangedCallback = function (name, oldVal, newVal) {
                    this[name] = newVal;
                };
                RHDPSearchFilterItemInline.prototype._updateFacet = function (e) {
                    this.bounce = true;
                    if (e.target['className'].indexOf('clearItem') >= 0) {
                        this.active = !this.active;
                    }
                };
                RHDPSearchFilterItemInline.prototype._checkParams = function (e) {
                    var _this = this;
                    var chk = false;
                    if (e.detail && e.detail.filters) {
                        Object.keys(e.detail.filters).forEach(function (group) {
                ...
                RHDPSearchFilterItemInline.prototype._checkChange = function (e) {
                    if (e.detail && e.detail.facet) {
                        if (!this.bounce) {
                            if (this.group === e.detail.facet.group && this.key === e.detail.facet.key) {
                                this.bubble = false;
                ...
                RHDPSearchFilterItemInline.prototype._clearFilters = function (e) {
                    this.bubble = false;
                    this.bounce = false;
                    this.active = false;
                };
                return RHDPSearchFilterItemInline;
            }(rhelement_14.default));
            exports_15("default", RHDPSearchFilterItemInline);
            customElements.define('rhdp-search-filter-item-inline', RHDPSearchFilterItemInline);
        }
    };
});
System.register("@rhd/rhdp-search/rhdp-search-active-filters", ["@rhelements/rhelement", "@rhd/rhdp-search/rhdp-search-filter-group", "@rhd/rhdp-search/rhdp-search-filter-item-inline"], function (exports_16, context_16) {
    "use strict";
    var __moduleName = context_16 && context_16.id;
    var rhelement_15, rhdp_search_filter_group_2, rhdp_search_filter_item_inline_1, RHDPSearchActiveFilters;
    return {
        setters: [
            function (rhelement_15_1) {
                rhelement_15 = rhelement_15_1;
            },
            function (rhdp_search_filter_group_2_1) {
                rhdp_search_filter_group_2 = rhdp_search_filter_group_2_1;
            },
            function (rhdp_search_filter_item_inline_1_1) {
                rhdp_search_filter_item_inline_1 = rhdp_search_filter_item_inline_1_1;
            }
        ],
        execute: function () {
            RHDPSearchActiveFilters = (function (_super) {
                ...
                function RHDPSearchActiveFilters() {
                    var _this = _super.call(this, 'rhdp-search-active-filters') || this;
                    _this.template = function (el) {
                        var tpl = document.createElement("template");
                ...
                Object.defineProperty(RHDPSearchActiveFilters.prototype, "type", {
                    get: function () {
                        return this._type;
                    },
                    set: function (val) {
                ...
                Object.defineProperty(RHDPSearchActiveFilters.prototype, "toggle", {
                    get: function () {
                        return this._toggle;
                    },
                    set: function (val) {
                ...
                RHDPSearchActiveFilters.prototype.addGroups = function () {
                    var groups = this.filters.facets, len = groups.length;
                    for (var i = 0; i < len; i++) {
                        var group = new rhdp_search_filter_group_2.default(), groupInfo = groups[i], gLen = groupInfo.items.length;
                        for (var j = 0; j < gLen; j++) {
                            var item = new rhdp_search_filter_item_inline_1.default();
                            item.name = groupInfo.items[j].name;
                            item.value = groupInfo.items[j].value;
                            item.active = groupInfo.items[j].active;
                            item.key = groupInfo.items[j].key;
                ...
                RHDPSearchActiveFilters.prototype._checkActive = function (e) {
                    if (e.detail) {
                        if (e.detail.facet) {
                            ...
                            var chk = this.shadowRoot.querySelectorAll('rhdp-search-filter-item-inline[active]');
                            if (chk.length > 0) {
                                this.style.display = 'block';
                            }
                            else {
                ...
                RHDPSearchActiveFilters.prototype._toggleModal = function (e) {
                    if (this.type === 'modal') {
            ...
            exports_16("default", RHDPSearchActiveFilters);
            customElements.define('rhdp-search-active-filters', RHDPSearchActiveFilters);
        }
    };
});
System.register("@rhd/rhdp-search/rhdp-search-modal-filters", ["@rhelements/rhelement", "@rhd/rhdp-search/rhdp-search-filter-group", "@rhd/rhdp-search/rhdp-search-filter-item"], function (exports_17, context_17) {
    "use strict";
    var __moduleName = context_17 && context_17.id;
    var rhelement_16, rhdp_search_filter_group_3, rhdp_search_filter_item_2, RHDPSearchModalFilters;
    return {
        setters: [
            function (rhelement_16_1) {
                rhelement_16 = rhelement_16_1;
            },
            function (rhdp_search_filter_group_3_1) {
                rhdp_search_filter_group_3 = rhdp_search_filter_group_3_1;
            },
        ...
        execute: function () {
            RHDPSearchModalFilters = (function (_super) {
                ...
                function RHDPSearchModalFilters() {
                    var _this = _super.call(this, 'rhdp-search-modal-filters') || this;
                    _this.template = function (el) {
                        var tpl = document.createElement("template");
                ...
                RHDPSearchModalFilters.prototype.addGroups = function () {
                    var groups = this.filters.facets, len = groups.length;
                    for (var i = 0; i < len; i++) {
                        var group = new rhdp_search_filter_group_3.default(), groupInfo = groups[i], gLen = groupInfo.items.length;
                        for (var j = 0; j < gLen; j++) {
                            var item = new rhdp_search_filter_item_2.default();
                            item.name = groupInfo.items[j].name;
                            item.value = groupInfo.items[j].value;
                            item.active = groupInfo.items[j].active;
                            item.key = groupInfo.items[j].key;
                ...
                RHDPSearchModalFilters.prototype._checkActive = function (e) {
                    if (e.detail) {
                        if (e.detail.facet) {
                            this.style.display = e.detail.facet.active ? 'block' : this.style.display;
                        }
                ...
                RHDPSearchModalFilters.prototype._initActive = function (e, group_key, item) {
                    if (e.detail && e.detail.filters) {
                        Object.keys(e.detail.filters).forEach(function (group) {
                            e.detail.filters[group].forEach(function (facet) {
                                if (group === group_key) {
                ...
                RHDPSearchModalFilters.prototype._addFilters = function () {
                    var groups = this.filters.facets;
                    for (var i = 0; i < groups.length; i++) {
                        var items = groups[i].items;
                        for (var j = 0; j < items.length; j++) {
            ...
            exports_17("default", RHDPSearchModalFilters);
            customElements.define('rhdp-search-modal-filters', RHDPSearchModalFilters);
        }
    };
});
System.register("@rhd/rhdp-search/rhdp-search-onebox", ["@rhelements/rhelement"], function (exports_18, context_18) {
    "use strict";
    var __moduleName = context_18 && context_18.id;
    var rhelement_17, RHDPSearchOneBox, templateObject_1;
    return {
        setters: [
        ...
        execute: function () {
            ...
            exports_18("default", RHDPSearchOneBox);
            customElements.define('rhdp-search-onebox', RHDPSearchOneBox);
        }
    };
});
System.register("@rhd/rhdp-search/rhdp-search-result", ["@rhelements/rhelement"], function (exports_19, context_19) {
    "use strict";
    var __moduleName = context_19 && context_19.id;
    var rhelement_18, RHDPSearchResult;
    return {
        setters: [
        ...
        execute: function () {
            ...
            exports_19("default", RHDPSearchResult);
            customElements.define('rhdp-search-result', RHDPSearchResult);
        }
    };
});
System.register("@rhd/rhdp-search/rhdp-search-results", ["@rhelements/rhelement", "@rhd/rhdp-search/rhdp-search-result"], function (exports_20, context_20) {
    "use strict";
    var __moduleName = context_20 && context_20.id;
    var rhelement_19, rhdp_search_result_1, RHDPSearchResults;
    return {
        setters: [
            function (rhelement_19_1) {
                rhelement_19 = rhelement_19_1;
            },
        ...
        execute: function () {
            RHDPSearchResults = (function (_super) {
                ...
                RHDPSearchResults.prototype._setLoading = function (e) {
                    var results = this.shadowRoot.querySelector('.results');
                    if (!this.more) {
                ...
                RHDPSearchResults.prototype.addResults = function (results) {
                    var resultlist = this.shadowRoot.querySelector('.results');
            ...
            }(rhelement_19.default));
            exports_20("default", RHDPSearchResults);
            customElements.define('rhdp-search-results', RHDPSearchResults);
        }
    };
});
System.register("@rhd/rhdp-search/rhdp-search-sort-page", ["@rhelements/rhelement"], function (exports_21, context_21) {
    "use strict";
    var __moduleName = context_21 && context_21.id;
    var rhelement_20, RHDPSearchSortPage;
    return {
        setters: [
            function (rhelement_20_1) {
                rhelement_20 = rhelement_20_1;
            }
        ],
        execute: function () {
            ...
            }(rhelement_20.default));
            exports_21("default", RHDPSearchSortPage);
            customElements.define('rhdp-search-sort-page', RHDPSearchSortPage);
        }
    };
});
System.register("@rhd/rhdp-search/rhdp-search-app", ["@rhelements/rhelement", "@rhd/rhdp-search/rhdp-search-url", "@rhd/rhdp-search/rhdp-search-query", "@rhd/rhdp-search/rhdp-search-box", "@rhd/rhdp-search/rhdp-search-result-count", "@rhd/rhdp-search/rhdp-search-filters", "@rhd/rhdp-search/rhdp-search-active-filters", "@rhd/rhdp-search/rhdp-search-modal-filters", "@rhd/rhdp-search/rhdp-search-onebox", "@rhd/rhdp-search/rhdp-search-results", "@rhd/rhdp-search/rhdp-search-sort-page"], function (exports_22, context_22) {
    "use strict";
    var __moduleName = context_22 && context_22.id;
    var rhelement_21, rhdp_search_url_1, rhdp_search_query_1, rhdp_search_box_1, rhdp_search_result_count_1, rhdp_search_filters_1, rhdp_search_active_filters_1, rhdp_search_modal_filters_1, rhdp_search_onebox_1, rhdp_search_results_1, rhdp_search_sort_page_1, RHDPSearchApp;
    return {
        setters: [
            function (rhelement_21_1) {
                rhelement_21 = rhelement_21_1;
            },
            ...
            function (rhdp_search_active_filters_1_1) {
                rhdp_search_active_filters_1 = rhdp_search_active_filters_1_1;
            },
            function (rhdp_search_modal_filters_1_1) {
                rhdp_search_modal_filters_1 = rhdp_search_modal_filters_1_1;
            },
        ...
        execute: function () {
            RHDPSearchApp = (function (_super) {
                ...
                function RHDPSearchApp() {
                    ...
                    _this.active = new rhdp_search_active_filters_1.default();
                    _this.modal = new rhdp_search_modal_filters_1.default();
            ...
            }(rhelement_21.default));
            exports_22("default", RHDPSearchApp);
            customElements.define('rhdp-search-app', RHDPSearchApp);
        }
    };
});
System.register("@rhd/rhd-app", ["@rhd/rhdp-alert", "@rhd/dp-category-list/dp-category-list", "@rhd/dp-category-list/dp-category", "@rhd/dp-category-list/dp-category-item-list", "@rhd/dp-category-list/dp-category-item", "@rhd/dp-category-list/dp-product-short-teaser", "@rhd/rhdp-search/rhdp-search-app"], function (exports_23, context_23) {
    "use strict";
    var __moduleName = context_23 && context_23.id;
    var rhdp_alert_1, dp_category_list_1, dp_category_1, dp_category_item_list_1, dp_category_item_1, dp_product_short_teaser_1, rhdp_search_app_1, RHDApp;
    return {
        setters: [
        ...
        execute: function () {
            RHDApp = (function () {
                function RHDApp() {
                    ...
                    this.g = new rhdp_search_app_1.default();
                }
                return RHDApp;
            }());
            exports_23("default", RHDApp);
        }
    };
});
...
System.register("@rhd/dp-stackoverflow/dp-stackoverflow", ["@rhelements/rhelement"], function (exports_24, context_24) {
    "use strict";
    var __moduleName = context_24 && context_24.id;
    var rhelement_22, DPStackOverflow;
    return {
        setters: [
            function (rhelement_22_1) {
                rhelement_22 = rhelement_22_1;
            }
        ],
        execute: function () {
            ...
            }(rhelement_22.default));
            exports_24("default", DPStackOverflow);
        }
    };
});
